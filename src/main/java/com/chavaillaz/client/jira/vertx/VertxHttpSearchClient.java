...
public class VertxHttpSearchClient<T extends List<? extends Issue>> extends AbstractVertxHttpClient implements SearchClient<T> {

    protected final JavaType issuesListType;

    /**
     * Creates a new {@link SearchClient} using Vert.x client.
     *
     ...
     */
    public VertxHttpSearchClient(WebClient client, String baseUrl, Authentication authentication, JavaType issuesListType) {
